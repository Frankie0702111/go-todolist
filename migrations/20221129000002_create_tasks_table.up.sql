...
INSERT INTO `tasks` (`user_id`, `category_id`, `title`, `note`, `url`, `img`, `img_link`, `img_uuid`, `specify_datetime`, `is_specify_time`, `priority`, `progress`, `is_complete`, `created_at`, `updated_at`)
VALUES
(1, 2, 'Read book', '10 pag to 15 pag', NULL, NULL, NULL, NULL, '2022-11-29 12:00:00', 1, 1, 'Draft', 0, '2022-11-29 09:00:00', '2022-11-29 09:00:00'),
(1, 1, 'Go to super market', 'apple', NULL, NULL, NULL, NULL, '2022-11-29 00:00:00', 0, 2, 'Processing', 0, '2022-11-29 09:00:00', '2022-11-29 09:00:00'),
(1, 3, 'dating with friends', 'Frankie, Daisy', 'https://goo.gl/maps/VcDMEzRLKpqPtm697', NULL, NULL, 'a44c445c-0060-4c8a-8409-17e9479f91df', '2022-11-29 14:00:00', 1, 3, 'Done', 1, '2022-11-29 09:00:00', '2022-11-29 09:00:00');
